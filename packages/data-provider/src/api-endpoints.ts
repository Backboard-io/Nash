...
export const init = () => `${BASE_URL}/api/init`;
export const user = () => `${BASE_URL}/api/user`;

export const analytics = () => `${BASE_URL}/api/analytics`;
...
export const continueSharedConvo = (shareId: string) => `${shareRoot}/${shareId}/continue`;
...
export const login = () => `${BASE_URL}/api/auth/signin`;

export const apiKeyLogin = () => `${BASE_URL}/api/auth/apikey-login`;

export const storeByokKey = () => `${BASE_URL}/api/keys`;
export const verifyByokSession = () => `${BASE_URL}/api/keys/verify`;
export const refreshByokSession = () => `${BASE_URL}/api/keys/refresh`;

export const logout = () => `${BASE_URL}/api/auth/logout`;

export const register = () => `${BASE_URL}/api/auth/signup`;
...
export const verifyEmail = () => `${BASE_URL}/api/auth/verify`;
...
export const mcpCatalog = () => `${BASE_URL}/api/mcp/catalog`;

export const mcpCatalogAdd = (serverName: string) =>
  `${BASE_URL}/api/mcp/catalog/${serverName}/add`;
...
export const filesUsage = () => `${BASE_URL}/api/files/usage`;
export const fileUpload = () => `${BASE_URL}/api/files`;
export const fileDelete = () => `${BASE_URL}/api/files`;
export const fileExport = () => `${BASE_URL}/api/files/export`;
...
export const userCookieConsent = () => `${BASE_URL}/api/user/cookie-consent`;
export const userChatAssistant = () => `${BASE_URL}/api/user/chat-assistant`;
...
export const adminEnableUsers = () => `${BASE_URL}/api/admin/users/enable`;

// Saved Responses
export const savedMessagesRoot = `${BASE_URL}/api/saved-messages`;

export const savedMessages = (folderId?: string | null) =>
  `${savedMessagesRoot}${folderId != null && folderId ? `?folderId=${encodeURIComponent(folderId)}` : ''}`;

export const savedMessageById = (messageId: string) =>
  `${savedMessagesRoot}/${encodeURIComponent(messageId)}`;

export const savedMessageFolders = () => `${savedMessagesRoot}/folders`;

export const savedMessageFolderById = (folderId: string) =>
  `${savedMessagesRoot}/folders/${encodeURIComponent(folderId)}`;
