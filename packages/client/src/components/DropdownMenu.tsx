...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      /* The same rule the ⋯ menus draw: --border, not --elevated. On an
         --elevated menu a --elevated separator is invisible. */
      className={cn('my-[5px] h-px bg-border-light', className)}
      {...props}
    />
  );
}
