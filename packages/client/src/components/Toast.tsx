...
export function Toast() {
  ...
  const severityClassName = {
    /* These colors keep a >=4.5:1 contrast ratio against the white toast text (WCAG AA).
     * SUCCESS uses the brand purple #635BFF (5.7:1); WARNING/ERROR were CCA-tuned in HSV
     * space to stay recognizably orange/red without compromising accessibility.
     * */
    [NotificationSeverity.INFO]: 'border-gray-500 bg-gray-500',
    [NotificationSeverity.SUCCESS]: 'border-[#635BFF] bg-[#635BFF]',
