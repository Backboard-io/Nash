...
const TagPrimitiveRoot = React.forwardRef<HTMLDivElement, TagProps>(
  (
    ...
    <div
      ...
      {...props}
      className={cn(
        'flex max-h-8 items-center overflow-y-hidden rounded-3xl border-2 border-brand-purple bg-brand-purple/20 text-xs text-brand-purple dark:text-white',
        className,
      )}
    >
      ...
      {CancelButton
        ...
        : onRemove && (
            <button
              ...
              className="rounded-full bg-brand-purple/50"
