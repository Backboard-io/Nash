...
| `packages/data-provider`, `packages/data-schemas`, `packages/client` | Shared frontend packages used by `client/`. |
| `packages/api` | Legacy/library code; **not** the active HTTP backend. |
