...
function ConvoOptions({
  ...
  const buttonClassName = cn(
    'inline-flex h-6 w-6 items-center justify-center rounded-[6px] border-none p-0 text-sm font-medium ring-ring-primary transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50',
      ...
      <DropdownPopup
        ...
        trigger={
          <Ariakit.MenuButton
            ...
            className={cn(
              'inline-flex h-6 w-6 items-center justify-center gap-2 rounded-[6px] border-none p-0 text-sm font-medium ring-ring-primary transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50',
              isActiveConvo === true || isPopoverActive
                ? 'opacity-100'
                : 'opacity-0 focus:opacity-100 group-focus-within:opacity-100 group-hover:opacity-100 data-[open]:opacity-100',
            )}
