...
export default function MobileNav({
  ...
  return (
    /* Same height and top padding as the drawer's header (NewChat) — the two
       wordmarks have to land on one line. */
    <div className="sticky top-0 z-10 flex h-14 flex-shrink-0 items-center justify-between bg-surface-primary px-5 pt-2 md:hidden">
      <button
        type="button"
      ...
      >
        ...
        {/* A panel icon, not a hamburger. This toggles the sidebar, and a
            hamburger says "menu" — the same control on desktop has always been
            `PanelLeft`, so the two now match. */}
