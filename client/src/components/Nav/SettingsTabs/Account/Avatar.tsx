    ...
    >
      <div className="flex items-center justify-between">
        ...
        <OGDialogTrigger asChild>
          <Button
            variant="link"
            className="h-auto p-0 font-medium text-text-primary transition-opacity hover:opacity-80"
          >
      ...
      <OGDialogContent showCloseButton={false} className="w-11/12 max-w-md">
        ...
        <div className="flex flex-col items-center justify-center p-2">
          {image != null ? (
            <>
              <div
                className={cn(
                  ...
                  isDragging && 'cursor-move ring-border-heavy',
                )}
            ...
            <div
              className="flex h-72 w-full flex-col items-center justify-center rounded-[10px] border-2 border-dashed border-border-light bg-transparent transition-colors hover:border-border-heavy"
              onDrop={handleDrop}
            ...
            >
              ...
              <p className="mb-4 text-center text-[12.5px] leading-[18px] text-text-secondary-alt">
