  ...
  return (
    <div className="flex items-center justify-between">
      ...
      <Dropdown
        ...
        className={cn('w-[240px] max-w-full', className)}
...
function General() {
  ...
  return (
    /* §2: settings rows are 13.5 body, not 14. The divider stays — a settings
       list is rows of unrelated switches, which is the one place §14's
       no-dividers rule does not apply. */
    <div className="flex flex-col divide-y divide-border-subtle text-[13.5px] leading-[20px] text-text-primary">
      ...
      {toggleSwitchConfigs.map((config) => (
        <div key={config.key} className="py-[15px]">
          <ToggleSwitch
