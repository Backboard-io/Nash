          ...
          return (
            <div className="flex items-center gap-2">
              <Link
                ...
                className="group flex items-center gap-1 truncate rounded-[7px] text-text-primary underline decoration-1 underline-offset-2 hover:decoration-2 focus:outline-none focus:ring-2 focus:ring-ring"
                title={title}
              >
            ...
            <TooltipAnchor
              ...
              render={
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-8 w-8 items-center justify-center rounded-lg p-0 transition-colors hover:bg-surface-hover focus:outline-none focus:ring-2 focus:ring-ring"
