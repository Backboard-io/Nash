  ...
  if (expanded) {
    return (
      <a
        ...
        className="flex w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-swap hover:bg-surface-tertiary"
      >
          ...
          <Ariakit.HovercardAnchor
            render={
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-full w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-swap hover:bg-surface-tertiary"
              >
                <div className="flex items-center gap-2">
                  <FaviconImage domain={domain} />
                  <span className="truncate text-xs font-medium text-text-secondary">{domain}</span>
              ...
              <div className="flex-1">
                <div className="mb-2 flex items-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="line-clamp-2 cursor-pointer overflow-hidden text-sm font-bold text-text-link hover:underline md:line-clamp-3"
                  >
...
function ImageItem({ image }: { image: ImageResult }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group overflow-hidden rounded-lg bg-surface-secondary transition-all duration-swap hover:bg-surface-tertiary"
    >
      {image.imageUrl && (
...
const FileItem = React.memo(function FileItem({
  ...
  if (expanded) {
    return (
      <button
        ...
        disabled={isLoading}
        className={`flex w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-swap disabled:opacity-50 ${
  ...
  return (
    <button
      onClick={isLocalFile ? undefined : handleDownload}
      disabled={isLoading}
      className={`flex h-full w-full flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-swap disabled:opacity-50 ${
        isLocalFile ? 'cursor-default' : 'hover:bg-surface-tertiary'
      }`}
      aria-label={
        isLocalFile ? localize('com_sources_download_local_unavailable') : downloadAriaLabel
  ...
  return (
    <div className="scrollbar-none grid w-full grid-cols-4 gap-2 overflow-x-auto">
      <OGDialog>
        ...
        {hasMoreSources && (
          <OGDialogTrigger className="flex flex-col rounded-lg bg-surface-primary-contrast px-3 py-2 text-sm transition-all duration-swap hover:bg-surface-tertiary">
            <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col gap-2">
              {[...visibleSources, ...remainingSources].map((source, i) => (
                ...
                >
                  ...
                  {'imageUrl' in source && source.imageUrl && (
                    <div className="hidden h-12 w-12 flex-shrink-0 overflow-hidden rounded-lg sm:block">
                      <img
                        src={source.imageUrl}
                        alt={source.title || localize('com_sources_image_alt')}
                        className="h-full w-full object-cover"
...
function TabWithIcon({ label, icon }: { label: string; icon: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2 rounded-lg px-3 py-1 text-sm transition-colors hover:bg-surface-tertiary hover:text-text-primary">
  ...
  const fallbackUI = (
    ...
    >
      ...
      <button
        ...
        className="hover:bg-surface-primary-hover rounded-lg bg-surface-primary px-3 py-1 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-ring"
