...
const PluginPagination: React.FC<TPluginPaginationProps> = ({
  ...
  return (
    <div className="flex max-w-full flex-wrap items-center justify-center gap-2 text-sm text-black/60 dark:text-white/70">
      <div
        role="button"
        tabIndex={0}
      ...
      {pages.map((page) => (
        <div
          ...
          key={page}
          tabIndex={0}
          className={`flex h-8 w-8 items-center justify-center text-sm sm:h-5 sm:w-5 ${
            currentPage === page
