      ...
      <div className="relative flex items-center justify-between rounded-tl-md rounded-tr-md bg-gray-850 px-4 py-2 font-sans text-xs text-gray-400">
        ...
        {plugin === true ? (
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <button
              type="button"
              className="ml-auto flex items-center gap-2 rounded px-2 py-1 transition-colors hover:bg-white/10 focus:bg-white/10 focus:outline-none"
              onClick={() => downloadCode(lang, codeRef)}
            >
              <Download className="h-[18px] w-[18px]" aria-hidden="true" />
              <span>{localize('com_ui_download')}</span>
            </button>
            <button
              type="button"
              className={cn(
                'ml-auto flex items-center gap-2 rounded px-2 py-1 transition-colors hover:bg-white/10 focus:bg-white/10 focus:outline-none',
            ...
            <TooltipAnchor
              ...
              render={
                <button
                  ...
                  className="flex items-center justify-center rounded p-1.5 hover:bg-gray-700 focus:bg-gray-700 focus:outline focus:outline-white"
                  onClick={() => downloadCode(lang, codeRef)}
                >
                  <Download className="h-[18px] w-[18px]" aria-hidden="true" />
                </button>
