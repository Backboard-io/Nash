...
const MermaidHeader: React.FC<MermaidHeaderProps> = memo(
  ({
    ...
    return (
      <div
        className={cn(
          'flex items-center justify-between rounded-tl-md rounded-tr-md bg-gray-700/80 px-4 py-2 font-sans text-xs text-gray-200 backdrop-blur-sm transition-opacity duration-hover',
          className,
        )}
      >
