...
const Mermaid: React.FC<MermaidProps> = memo(({ children, id, theme }) => {
  ...
  const zoomControls = (
    <div
      className={cn(
        'absolute bottom-2 right-2 z-10 flex items-center gap-1 rounded-md border border-border-light bg-surface-secondary p-1 shadow-lg transition-opacity duration-hover',
        ...
        >
          <div
            ...
            style={{
              ...
              transition: isDialogPanning ? 'none' : 'transform 0.1s ease-nash',
            }}
          >
            <img
              src={blobUrl}
  ...
  if (isLoading) {
    ...
    if (lastValidSvgRef.current && blobUrl) {
      return (
        <div
          className={cn(
            'relative w-full overflow-hidden rounded-md border transition-all duration-hover',
        ...
        >
          ...
          <div
            ref={containerRef}
            className={cn(
              'relative overflow-hidden p-4 transition-colors duration-hover',
              'rounded-md',
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                transition: isPanning ? 'none' : 'transform 0.1s ease-nash',
              }}
            >
              <img
                src={blobUrl}
    ...
    <>
      ...
      >
        ...
        {showCode && (
          <div
            className={cn(
              'border-b border-border-medium bg-surface-secondary p-4 pt-12 transition-opacity duration-hover',
              showControls ? 'opacity-100' : 'pointer-events-none opacity-0',
            )}
          >
            <pre className="overflow-auto whitespace-pre-wrap text-xs text-text-secondary">
