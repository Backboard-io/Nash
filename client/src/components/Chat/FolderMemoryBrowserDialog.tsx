    ...
    <div className="group rounded-lg border border-border-light bg-transparent px-3 py-2.5 hover:bg-surface-secondary">
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          disabled={isLoading}
          className={`ml-auto flex size-7 shrink-0 items-center justify-center rounded-lg opacity-0 transition-all duration-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-border-heavy group-hover:opacity-100 ${
            confirming
