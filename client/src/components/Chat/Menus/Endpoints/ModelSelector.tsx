      ...
      render={
        <button
          ...
          className={cn(
            'flex items-center',
            isPill
              ? 'max-w-[14rem] flex-shrink-0 gap-[12px] bg-transparent text-[13px] leading-[19.5px] text-text-secondary-alt transition-colors hover:text-text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-ring dark:text-text-secondary md:min-w-0'
