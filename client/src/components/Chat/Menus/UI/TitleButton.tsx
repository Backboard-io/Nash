...
export default function TitleButton({ primaryText = '', secondaryText = '' }) {
  ...
  return (
    <Trigger asChild>
      <button
        className="group flex cursor-pointer items-center gap-2 rounded-lg px-3 py-1.5 text-lg font-medium transition-colors duration-hover hover:bg-surface-hover radix-state-open:bg-surface-hover"
