      ...
      <Ariakit.PopoverAnchor
        ...
        render={
          <button
            ...
            aria-haspopup="menu"
          >
            <ThumbUpIcon size="16" bold={feedback?.rating === 'thumbsUp'} />
          </button>
        }
      />
      <Ariakit.Popover
      ...
      <Ariakit.PopoverAnchor
        ...
        render={
          <button
            ...
            aria-haspopup="menu"
          >
            <ThumbDownIcon size="16" bold={feedback?.rating === 'thumbsDown'} />
          </button>
        }
      />
      <Ariakit.Popover
...
function buttonClasses(isActive: boolean, isLast: boolean) {
  return cn(
    'hover-button flex h-7 w-7 items-center justify-center rounded-md p-1.5 text-text-secondary-alt',
