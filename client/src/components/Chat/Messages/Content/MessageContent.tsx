...
const ErrorBox = ({
  ...
  <div
    ...
    className={cn(
      ...
      'bg-[#FCE8EF] text-[13px] leading-[19.5px] text-text-destructive dark:bg-[#2D1520]',
      className,
    )}
  >
...
const MessageContent = ({
  ...
  const shouldRenderDisplayMessage =
    !showOnlyGeneratingPlaceholder &&
    (regularContent.length > 0 || !message.isCreatedByUser || !message.files?.length);
