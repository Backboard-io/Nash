    ...
    <DialogPrimitive.Root open={isOpen} onOpenChange={onOpenChange}>
      <DialogPrimitive.Portal>
        ...
        >
          ...
          <div
            className={`absolute top-4 z-20 flex items-center gap-2 transition-[right] duration-swap ${isPromptOpen ? 'right-[336px]' : 'right-4'}`}
          >
            {zoom > 1 && (
              <TooltipAnchor
          ...
          <div
            className={`transition-[margin] duration-swap ${isPromptOpen ? 'mr-80' : ''}`}
          ...
          >
            ...
            >
              <div
                className="transition-transform duration-press ease-nash"
                style={{
          ...
          <div
            data-side-panel
            className={`fixed right-0 top-0 z-30 h-full w-80 transform border-l border-white/10 bg-surface-primary shadow-2xl transition-transform duration-swap ${
