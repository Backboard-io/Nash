...
function Divider() {
  return <div className="mx-3 h-px bg-border-light" aria-hidden="true" />;
}

const rowClassName = cn(
  'flex h-[60px] w-full items-center justify-between rounded-[10px] px-3 sm:h-16 sm:px-4',
  'transition-colors hover:bg-surface-active focus:outline-none',
  ...
  return (
    <>
      ...
      <NashBottomSheet open={open} onClose={onClose} ariaLabel={localize('com_ui_add_to_chat')}>
        <div className="flex flex-col gap-3 px-4 pb-5 sm:gap-4 sm:px-5 sm:pb-6">
          ...
          <div className="flex items-stretch gap-3 sm:gap-4">
            <button
              ...
              className={cn(
                'flex h-[96px] flex-1 flex-col items-center justify-center gap-2 rounded-[14px] bg-surface-hover text-text-secondary sm:h-[112px]',
                'transition-colors hover:bg-surface-active focus:outline-none',
                'disabled:cursor-not-allowed disabled:opacity-[.42]',
              )}
            >
              <Paperclip size={26} aria-hidden="true" />
              <span className="text-[13px] leading-[19px] text-text-primary dark:text-text-secondary">
            ...
            <button
              ...
              className={cn(
                'flex h-[96px] flex-1 flex-col items-center justify-center gap-2 rounded-[14px] sm:h-[112px]',
                'transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-ring',
                imageOn
                  ? 'bg-surface-active text-brand-purple'
          ...
          <div className="rounded-[14px] bg-surface-hover p-1">
            ...
            >
              <span className="flex items-center gap-3">
                ...
                <span className="text-[15px] leading-[22px] text-text-primary">
            ...
            {canUseMcp && (
              <>
                ...
                <button
                  ...
                  aria-label={localize('com_ui_connectors')}
