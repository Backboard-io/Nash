    ...
    <TooltipAnchor
      render={
        <Ariakit.MenuButton
          ...
          className={cn(
            'flex h-[34px] w-[34px] items-center justify-center rounded-full bg-surface-active text-text-secondary transition-colors hover:bg-surface-active-alt focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-opacity-50',
