...
const AttachFileMenu = ({
  ...
  const triggerClassName =
    'inline-flex h-[34px] flex-shrink-0 items-center gap-[7px] rounded-[18px] border border-border-light bg-transparent pl-[11px] pr-[13px] text-[13px] leading-[19.5px] text-text-secondary transition-colors hover:bg-surface-hover hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-opacity-50';
