    ...
    <>
      ...
      >
        {progress < 1 ? (
          ...
          <div
            className={cn(
              'absolute inset-0 flex transform-gpu cursor-pointer items-center justify-center rounded-xl transition-opacity duration-hover ease-nash',
          ...
          >
            <Maximize2
              className={cn(
                'size-5 transform-gpu text-white drop-shadow-lg transition-all duration-hover',
                isHovered ? 'scale-110' : '',
              )}
            />
          </div>
