...
const DragDropOverlay = memo(({ isActive }: DragDropOverlayProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[9998] transition-opacity duration-hover ease-nash ${
          isActive
      ...
      <div
        className={`fixed inset-0 z-[9999] flex flex-col items-center justify-center gap-2 text-text-primary transition-all duration-hover ease-nash ${
          isActive
            ? 'pointer-events-auto visible opacity-100'
            : 'pointer-events-none invisible opacity-0'
        } `}
        ...
        <div className="bg-surface-primary/95 flex flex-col items-center rounded-lg p-8 shadow-xl">
          <svg
            ...
            style={{
              ...
              transition: 'transform 0.2s ease-nash',
            }}
          >
