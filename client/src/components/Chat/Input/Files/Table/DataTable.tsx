    ...
    <div className="flex h-full flex-col gap-4">
      <div className="flex flex-wrap items-center gap-2 py-2 sm:gap-4 sm:py-4">
        <Button
          ...
          className={cn('min-w-[40px] transition-all duration-hover', isSmallScreen && 'px-2 py-1')}
        >
          {isDeleting ? (
      ...
      <div className="relative grid h-full max-h-[calc(100vh-20rem)] min-h-[calc(100vh-20rem)] w-full flex-1 overflow-hidden overflow-x-auto overflow-y-auto rounded-lg border border-black/10 dark:border-white/10">
