      ...
      {!isSmallScreen && renaming && (
        ...
        >
          ...
          <input
            ...
            className="w-48 truncate rounded-md border border-border-medium bg-surface-primary px-2 py-1 text-sm font-semibold text-text-primary focus:outline-none focus:ring-2 focus:ring-ring"
          />
          <button
            type="submit"
            aria-label={localize('com_ui_save')}
            className="flex size-7 items-center justify-center rounded-md text-text-secondary transition-colors hover:bg-surface-hover"
          >
