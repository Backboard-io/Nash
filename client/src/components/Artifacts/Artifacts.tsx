      ...
      <div className="flex h-full w-full flex-col">
        ...
        {isMobile && (
          <div
            className={cn(
              ...
              isVisible && !isClosing
                ? 'transition-all duration-swap'
                : 'pointer-events-none opacity-0 backdrop-blur-none transition-opacity duration-hover',
          ...
          className={cn(
            ...
            isMobile
              ? cn(
                  ...
                  isDragging ? '' : 'transition-all duration-swap',
                )
              : cn(
                  'h-full shadow-2xl',
                  isVisible && !isClosing
                    ? 'duration-move translate-x-0 opacity-100 transition-all'
                    : 'translate-x-5 opacity-0 transition-all duration-swap',
                ),
          )}
        ...
        >
          {isMobile && (
            ...
            >
              <div className="h-1 w-12 rounded-full bg-border-xheavy opacity-40 transition-all duration-hover active:opacity-60" />
            </div>
          )}
          ...
          <div
            className={cn(
              'flex flex-shrink-0 items-center justify-between gap-2 border-b border-border-light bg-surface-primary-alt px-3 py-2 transition-all duration-swap',
          ...
          >
            {!isMobile && (
              <div
                className={cn(
                  'flex items-center transition-all duration-page',
                  isVisible && !isClosing
            ...
            <div
              className={cn(
                'flex items-center gap-2 transition-all duration-page',
                isMobile ? 'min-w-max' : '',
              ...
              {activeTab === 'preview' && (
                ...
                >
                  {isRefreshing ? (
                    ...
                    <RefreshCw
                      size={16}
                      className="transition-transform duration-hover"
                      aria-hidden="true"
                    />
                  )}
                </Button>
          ...
          <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-surface-primary">
            ...
            <div
              className={cn(
                'absolute inset-0 z-[60] flex items-center justify-center bg-black/70 backdrop-blur-sm transition-opacity duration-swap ease-nash',
            ...
            >
              <div
                className={cn(
                  'transition-transform duration-swap ease-nash',
