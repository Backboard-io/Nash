  ...
  return (
    <Ariakit.ComboboxProvider store={combobox}>
      ...
      <>
        <div
          className={cn(
            'group relative flex h-10 cursor-pointer items-center gap-2 rounded-lg border-border-medium text-text-primary transition-colors duration-hover focus-within:bg-surface-hover hover:bg-surface-hover',
