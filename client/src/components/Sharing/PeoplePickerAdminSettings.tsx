        ...
        <div className="p-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownPopup
              ...
              trigger={
                <Ariakit.MenuButton className="inline-flex w-1/4 items-center justify-center rounded-lg border border-border-light bg-transparent px-2 py-1 text-text-primary transition-all ease-nash hover:bg-surface-tertiary">
                  {selectedRole}
                </Ariakit.MenuButton>
              }
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="btn rounded bg-brand-purple font-bold text-white transition-all hover:bg-brand-purple-hover"
              >
