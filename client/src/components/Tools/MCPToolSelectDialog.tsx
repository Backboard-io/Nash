  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <DialogPanel
          className="relative max-h-[90vh] w-full transform overflow-hidden overflow-y-auto rounded-lg bg-surface-secondary text-left shadow-xl transition-all max-sm:h-full sm:mx-7 sm:my-8 sm:min-h-[610px] sm:max-w-2xl lg:max-w-5xl xl:max-w-7xl"
        >
          <div className="flex items-center justify-between border-b-[1px] border-border-medium px-4 pb-4 pt-5 sm:p-6">
            ...
            <div>
              <button
                ...
                className="inline-block rounded-full text-text-secondary transition-colors hover:text-text-primary max-sm:-m-2 max-sm:p-2"
            ...
            <div className="mt-4 flex flex-col gap-4">
              ...
              >
                ...
                <input
                  ...
                  className="w-64 min-w-0 rounded border border-border-medium bg-transparent px-2 py-2 text-text-primary focus:outline-none sm:py-1"
                />
              </div>
