...
function ToolItem({ tool, onAddTool, onRemoveTool, isInstalled = false }: ToolItemProps) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded border border-border-medium bg-transparent p-4 sm:p-6">
      <div className="flex gap-4">
        ...
        <div className="flex min-w-0 flex-col items-start justify-between">
          ...
          {!isInstalled ? (
            <button
              className="btn btn-primary relative max-sm:py-2.5"
            ...
            <button
              className="btn relative bg-gray-300 hover:bg-gray-400 max-sm:py-2.5 dark:bg-gray-50 dark:hover:bg-gray-200"
              onClick={handleClick}
