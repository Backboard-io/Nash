        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="h-10 w-full rounded-lg border border-border-medium bg-surface-secondary px-3 text-sm text-text-primary focus:outline-none"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full resize-y rounded-lg border border-border-medium bg-surface-secondary p-3 text-sm text-text-primary focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pt-1">
            <button
              ...
              onClick={saveEdit}
              disabled={!canSave}
              className="inline-flex items-center justify-center gap-1.5 rounded-lg px-4 py-2 text-sm font-medium bg-text-primary text-surface-primary transition-opacity hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:opacity-60"
            >
