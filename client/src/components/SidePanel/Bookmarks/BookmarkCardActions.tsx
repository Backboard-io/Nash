    ...
    <div className="flex items-center gap-0.5">
      ...
      <OGDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
        ...
        <OGDialogTemplate
          ...
          selection={{
            ...
            /* §7: one confirm, one shape. This was `bg-red-700 dark:bg-red-600`
               against the agent dialog's `--surface-destructive`, so the same
               question asked in two places arrived in two different reds. */
            selectClasses:
      ...
      <Ariakit.MenuProvider placement="bottom-end">
        ...
        <Ariakit.Menu
          gutter={4}
          portal
          className="nash-menu z-50 min-w-[10rem] rounded-[12px] p-1 focus:outline-none"
        >
          <Ariakit.MenuItem
            onClick={onView}
            className="flex cursor-pointer items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-text-primary outline-none data-[active-item]:bg-surface-tertiary"
          >
