...
export default function Action({ action, onClick }: { action: Action; onClick: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'h-9 w-9 min-w-9 items-center justify-center rounded-lg transition-colors duration-hover hover:bg-surface-tertiary focus:outline-none focus:ring-2 focus:ring-text-primary group-focus:flex',
