...
const AssistantConversationStarters: React.FC<AssistantConversationStartersProps> = ({
  ...
  const defaultStyle = {
    transition: 'opacity 200ms ease-nash',
    opacity: 0,
  };
            ...
            {(state: string) => (
              ...
              >
                <TooltipAnchor
                  ...
                  className="flex size-7 items-center justify-center rounded-lg transition-colors duration-hover hover:bg-surface-hover"
        ...
        {field.value.map((starter, index) => (
          <div key={index} className="relative">
            ...
            <TooltipAnchor
              ...
              className="absolute right-1 top-1 flex size-7 items-center justify-center rounded-lg transition-colors duration-hover hover:bg-surface-hover"
