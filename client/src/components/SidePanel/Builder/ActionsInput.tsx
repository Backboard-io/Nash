    ...
    <>
      <div className="">
        <div className="mb-1 flex flex-wrap items-center justify-between gap-4">
          ...
          {/* TODO: implement an examples/template picker for action schemas */}
        </div>
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          onClick={saveAction}
          className="focus:shadow-outline mt-1 flex min-w-[100px] items-center justify-center rounded bg-brand-purple px-4 py-2 font-semibold text-white hover:bg-brand-purple-hover focus:border-brand-purple focus:outline-none focus:ring-0 disabled:bg-brand-purple-hover"
          type="button"
        >
          {submitContext()}
        </button>
