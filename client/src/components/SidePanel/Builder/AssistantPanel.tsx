    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="flex w-full flex-wrap">
          ...
          {assistant_id && (
            <button
              className="btn btn-primary focus:shadow-outline mx-2 mt-1 h-[40px] rounded bg-brand-purple px-4 py-2 font-semibold text-white hover:bg-brand-purple-hover focus:border-brand-purple focus:outline-none focus:ring-0"
              type="button"
        ...
        <div className="bg-surface-50 h-auto px-4 pb-8 pt-3 dark:bg-transparent">
              ...
              render={({ field, fieldState: { error } }) => (
                <>
                  <SelectDropDown
                    ...
                    containerClassName={cn('rounded-lg', error ? 'border-red-500 border-2' : '')}
                  />
                  {error && (
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            {/* Submit Button */}
            <button
              className="btn btn-primary focus:shadow-outline flex w-full items-center justify-center px-4 py-2 font-semibold text-white hover:bg-brand-purple-hover focus:border-brand-purple"
              type="submit"
            >
              {submitContext}
            </button>
