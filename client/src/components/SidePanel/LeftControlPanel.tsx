  ...
  return (
    <>
      <button
        ...
        onClick={close}
        className={cn(
          'absolute inset-0 z-40 bg-black/30 transition-opacity duration-hover',
      ...
      <aside
        aria-hidden={!isOpen}
        className={cn(
          'absolute left-0 top-0 z-50 flex h-full flex-col border-r border-border-light bg-surface-primary-alt shadow-xl transition-transform duration-hover ease-nash',
