  ...
  return (
    <HoverCard openDelay={50}>
      ...
      <div className="space-y-1">
        {/* Current fixed agent */}
        <div className="flex h-10 items-center justify-between rounded-lg border border-border-medium bg-surface-primary-contrast px-3 py-2">
          <div className="flex items-center gap-2">
        ...
        {agentIds.map((agentId, idx) => (
          <React.Fragment key={agentId}>
            <div className="flex h-10 items-center gap-2 rounded-lg border border-border-medium bg-surface-tertiary pr-2">
              <ControlCombobox
                isCollapsed={false}
