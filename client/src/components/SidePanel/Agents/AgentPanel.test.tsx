...
// DeleteButton is unrelated to the update-toast flow under test and pulls in
// chat/index-options hooks that aren't wired up here.
jest.mock('./DeleteButton', () => ({
  __esModule: true,
  default: () => <button data-testid="delete-agent-button">{`Delete`}</button>,
}));
