...
export function NoImage() {
  return (
    <div className="flex h-full w-full items-center justify-center rounded-full border-2 border-dashed border-border-medium text-text-secondary">
      <svg
        stroke="currentColor"
        fill="none"
        strokeWidth="2"
      ...
      <div className="relative h-20 w-20 overflow-hidden rounded-full">
        <img
          ...
          style={{
            ...
            transition: 'opacity 0.2s ease-nash',
          }}
        />
