              ...
              >
                ...
                <div className="flex items-center">
                  <div className="relative flex items-center">
                    <div
                      className={cn(
                        'absolute right-0 transition-all duration-swap',
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <Checkbox
                            ...
                            className={cn(
                              'h-4 w-4 rounded border border-border-medium transition-all duration-hover hover:border-border-heavy',
                        ...
                        {deferredToolsEnabled && (
                          <TooltipAnchor
                            ...
                            className={cn(
                              'flex h-7 w-7 items-center justify-center rounded transition-colors duration-hover',
                        ...
                        {programmaticToolsEnabled && (
                          <TooltipAnchor
                            ...
                            className={cn(
                              ...
                              isExpanded ? 'visible' : 'pointer-events-none invisible',
                              allProgrammatic
                                ? 'bg-brand-purple/20 text-brand-purple hover:bg-brand-purple-hover/30'
                                : 'text-text-tertiary hover:bg-surface-hover hover:text-text-primary',
                            )}
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        <div className="flex items-center gap-1">
                          <AccordionPrimitive.Trigger asChild>
                            <button
                              ...
                              onClick={(e) => e.stopPropagation()}
                              className={cn(
                                'flex h-7 w-7 items-center justify-center rounded transition-colors duration-hover hover:bg-surface-active-alt focus:translate-x-0 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1',
                          ...
                          <OGDialogTrigger asChild>
                            <button
                              type="button"
                              className="flex h-7 w-7 items-center justify-center rounded transition-colors duration-hover hover:bg-surface-active-alt focus:translate-x-0 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1"
                              onClick={(e) => e.stopPropagation()}
