...
const labelClass = 'mb-2 block text-sm font-medium text-token-text-primary';
const inputClass = cn(
  defaultTextProps,
      ...
      <div className="h-auto bg-white px-4 pt-3 dark:bg-transparent">
        ...
        <div className="mb-4">
          <label className={labelClass} htmlFor="category-selector">
            {localize('com_ui_category')} <span className="text-brand-purple">*</span>
          </label>
        ...
        <div className="mb-4">
          ...
          >
            <div className="flex w-full items-center gap-2">
              ...
              <span>
                {model != null && model ? formatModelName(model) : localize('com_ui_select_model')}
              </span>
            </div>
          </button>
        </div>
        {(codeEnabled ||
          ...
          <div className="mb-4 flex w-full flex-col items-start gap-3">
            <label className={labelClass}>{localize('com_assistants_capabilities')}</label>
            {/* Code Execution */}
