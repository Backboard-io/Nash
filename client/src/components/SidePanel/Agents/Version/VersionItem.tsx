  ...
  return (
    <div className="rounded-lg border border-border-light p-3">
      <div className="flex items-center justify-between font-medium">
        ...
        {isActive && (
          <span className="rounded-full border border-brand-purple bg-brand-purple/20 px-2 py-0.5 text-xs font-medium text-violet-700 dark:border-brand-purple dark:bg-brand-purple/30 dark:text-violet-300">
