        ...
        {onRetry && (
          <div className="pt-2">
            <Button
              ...
              size="sm"
              className={cn(
                'bg-brand-purple text-brand-purple-foreground hover:bg-brand-purple-hover',
                'focus:ring-2 focus:ring-brand-purple focus:ring-offset-2 focus:ring-offset-presentation',
              )}
