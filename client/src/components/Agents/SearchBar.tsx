  ...
  return (
    <div className={`relative w-full ${className}`} role="search">
      ...
      <Input
        ...
        className="h-12 rounded-xl border border-border-light bg-surface-tertiary pl-12 pr-12 text-base text-text-primary transition-[border-color,box-shadow] duration-200 placeholder:text-text-secondary focus:border-brand-purple focus:ring-1 focus:ring-brand-purple"
