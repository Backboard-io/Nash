...
const BookmarkItem: FC<MenuItemProps> = ({ tag, selected, handleSubmit, icon, ...rest }) => {
  ...
  return (
    <MenuItem
      ...
      className="group flex w-full gap-2 rounded-lg p-2.5 text-sm text-text-primary transition-colors duration-hover focus:outline-none data-[focus]:bg-surface-hover data-[focus-visible]:ring-2 data-[focus-visible]:ring-primary"
      {...rest}
      as="button"
