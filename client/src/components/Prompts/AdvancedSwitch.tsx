...
const AdvancedSwitch = () => {
  ...
  return (
    <div className="relative flex h-10 items-center justify-center rounded-xl border border-border-light bg-surface-primary transition-all duration-swap">
      <div className="relative flex w-48 items-stretch md:w-64">
        <div
          className="absolute rounded-lg bg-surface-hover shadow-lg transition-all duration-swap ease-nash"
          style={{
            top: '1px',
        ...
        <button
          ...
          className={`relative z-10 flex-1 rounded-xl px-3 py-2 text-sm transition-all duration-swap md:px-6 ${
