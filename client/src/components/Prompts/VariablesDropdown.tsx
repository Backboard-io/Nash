      ...
      <DropdownPopup
        ...
        trigger={
          <Menu.MenuButton
            ...
            className="flex h-8 items-center gap-1 rounded-lg border border-border-medium bg-surface-secondary px-2 py-0 text-sm text-text-primary transition-colors duration-hover hover:bg-surface-tertiary"
          >
