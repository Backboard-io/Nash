          ...
          render={
            <Tag
              ...
              className={cn(
                ...
                tag === 'production'
                  ? 'bg-violet-100 text-violet-700 dark:border-brand-purple dark:bg-transparent dark:text-violet-400'
                ...
                if (tag === 'production') {
                  return (
                    <div className="flex items-center">
                      <span className="slow-pulse size-2 rounded-full bg-violet-400" />
                    </div>
                  );
                }
                if (tag === 'latest') {
...
const VersionCard = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        'group relative w-full rounded-lg border border-border-light p-4 transition-all duration-swap',
        isSelected
