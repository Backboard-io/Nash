...
function DashGroupItemComponent({ group, instanceProjectId }: DashGroupItemProps) {
  ...
  return (
    <div
      className={cn(
        'relative mx-2 my-2 rounded-lg border border-border-light bg-surface-primary shadow-sm transition-all duration-swap ease-nash hover:bg-surface-secondary',
          ...
          <OGDialog>
            <OGDialogTrigger asChild>
              <button
                ...
                className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-border-medium bg-transparent p-0 text-sm font-medium transition-all duration-swap ease-nash hover:border-border-heavy hover:bg-surface-hover focus:border-border-heavy focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
