...
function ChatGroupItem({
  ...
  return (
    <>
      <div className="relative my-2 items-stretch justify-between rounded-xl border border-border-light px-1 shadow-sm transition-all duration-swap ease-nash hover:bg-surface-tertiary hover:shadow-lg">
        <ListCard
          name={group.name}
          ...
          <DropdownMenu modal={false}>
            <DropdownMenuTrigger asChild>
              <button
                ...
                className="z-50 mr-2 inline-flex h-8 w-8 items-center justify-center rounded-lg border border-border-medium bg-transparent p-0 text-sm font-medium transition-all duration-swap ease-nash hover:border-border-heavy hover:bg-surface-hover focus:border-border-heavy focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
              >
