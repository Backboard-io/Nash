      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full px-4 py-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                <div className="relative mb-1 flex flex-col md:mb-0">
                  ...
                  <label
                    htmlFor="prompt-name"
                    className="pointer-events-none absolute -top-1 left-3 origin-[0] translate-y-3 scale-100 rounded bg-white px-1 text-base text-text-secondary transition-transform duration-hover peer-placeholder-shown:translate-y-3 peer-placeholder-shown:scale-100 peer-focus:-translate-y-2 peer-focus:scale-75 peer-focus:text-text-primary peer-[:not(:placeholder-shown)]:-translate-y-2 peer-[:not(:placeholder-shown)]:scale-75 dark:bg-gray-850"
                  >
        ...
        <div className="flex w-full flex-col gap-4 md:mt-[1.075rem]">
          <div>
            ...
            <div className="min-h-32 rounded-b-lg border border-border-medium p-4 transition-all duration-hover">
              <Controller
                name="prompt"
                control={control}
