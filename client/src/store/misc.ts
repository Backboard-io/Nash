...
import { SettingsTabValues, TAttachment } from 'librechat-data-provider';
...
const activeFolderId = atom<string | null>({
  key: 'activeFolderId',
  default: null,
});


const showSettings = atom<boolean>({
  key: 'showSettings',
  default: false,
});

const settingsInitialTab = atom<SettingsTabValues | null>({
