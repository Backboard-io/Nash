...
export default function RouteErrorBoundary() {
  ...
  return (
    ...
    >
      <div className="bg-surface-primary/60 mx-4 w-11/12 max-w-4xl rounded-2xl border border-border-light p-5 shadow-2xl backdrop-blur-xl sm:p-8">
        ...
        <div className="mb-4 rounded-xl border border-red-500/20 bg-red-500/5 p-4 text-sm text-gray-600 dark:text-gray-200">
          ...
          <pre className="whitespace-pre-wrap break-words text-sm font-light leading-relaxed text-text-primary">
        ...
        {errorDetails.data != null && (
          <details className="group mb-4 rounded-xl border border-border-light p-4">
            ...
            <pre className="whitespace-pre-wrap break-words text-xs font-light leading-relaxed text-text-primary">
